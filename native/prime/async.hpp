...
namespace dty::threading
{
    ...
    class AsyncResult final : public TianyuObject
    {
        ...
        __PUB__ AsyncResult()
            ...
            _State(new dty::threading::AsyncState(dty::threading::AsyncState::Unknown)),
            _Result(new T()),
    ...
    class Func final : public dty::TianyuObject
    {
        ...
        __PUB__ AsyncResult<TReturn> __VARIABLE__ BeginInvoke(Args ...params, ActionCallbackDelegate __VARIABLE__ endInvoke)
        {
            ...
            try
            {
                ...
                result.SetState(dty::threading::AsyncState::Success);
            }
            catch (std::exception)
            {
                result.SetState(dty::threading::AsyncState::Failure);
            }
