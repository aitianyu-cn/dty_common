...
namespace dty::collection
{
    ...
    _interface IIteratorEntity : public virtual dty::TianyuObject
    {
        ...
        __PUB__ virtual T_FR  __VARIABLE__ Every(IIteratorEntity<T>::ItemChkDelegate     __VARIABLE__ delegate) __pure_virtual_fun;
        ...
        public virtual dty::collection::IIteratorEntity<T>
    {
        ...
        __PUB__ virtual T_FR  __VARIABLE__ Every(IteratorEntity<T>::ItemChkDelegate     __VARIABLE__ delegate) __override_func;
