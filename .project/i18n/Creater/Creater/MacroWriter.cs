...
namespace DTY.Native.Tools.I18N.Creater
{
    internal class MacroWriter
    {
        ...
        private void _StartMacro()
        {
            ...
            _writer.WriteLine("//");
            _writer.WriteLine("// 此文件由天宇自动化生成器生成，请勿手动更改");
            _writer.WriteLine("// This file is generated by Tianyu Automatic Creater");
            _writer.WriteLine("// Please do NOT manually change");
            _writer.WriteLine("//");
            _writer.WriteLine("// #####################################################");
            _writer.WriteLine();
